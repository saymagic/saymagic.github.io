---
layout: post
keywords: 崩溃信息收集,android,crash
description: Android应用程序产生崩溃时所应该做的处理。
title: Android崩溃处理
categories: [Android]
tags: [ANDROID]
group: archive
...
![](/pic/android-crash-analyze/140925141910.gif)

我将崩溃上传到了我的sae服务器的storage里。下图中红色圈起来的文件即是我们上传的崩溃文件。

![](/pic/android-crash-analyze/140925142145.png)
...
[bughd](http://bughd.com/){:rel="nofollow"}:这是国内Fir.im的一款产品，使用起来非常简单。

[fabric](https://fabric.io/){:rel="nofollow"}: Twitter出品，非常强大。
...
Android里有一种比较常见的问题，那就是ANR，关于ANR的相关知识可以阅读我的另一篇博文[http://blog.saymagic.cn/2014/03/25/anr-analyze.html](http://blog.saymagic.cn/2014/03/25/anr-analyze.html)
