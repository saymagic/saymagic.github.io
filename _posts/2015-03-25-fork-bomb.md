---
layout: post
keywords: fork,bomb,Fork炸弹
description: 经典的Fork炸弹
title: 经典的Fork炸弹
categories: [Exp]
tags: [Linux]
group: archive
...
![](/pic/fork-bomb/o_19h7mgb2u1iog9ke1771ftn15eaj.png)

这个时候我们再次运行炸弹就不会报内存不足了，而是提示`-bash: fork: retry: No child processes`，很棒，此时说明Linux限制了炸弹创建线程。

![Fine with me](/pic/fork-bomb/8aMiaV16NGxLwTVkTOS210u6U0MFhMTCT26Om6yZK7Y1bXFusLbfaT2OjUICOUmCMtxOtfdn2WsOkPRksUC9VrQ.gif)

## 参考

[http://en.wikipedia.org/wiki/Fork_bomb](http://en.wikipedia.org/wiki/Fork_bomb){:rel="nofollow"}
